...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_LCTL, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                 KC_F6, KC_F7, KC_F8, KC_HOME,KC_UP,KC_END,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_LSFT, KC_F9, KC_F10,KC_F11,KC_F12,KC_NO,                 KC_NO,KC_PGUP,KC_PGDN,KC_LEFT,KC_DOWN,KC_RIGHT,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                KC_LALT,KC_LGUI,KC_SPC,   KC_ENT, RAISE,LOWER \
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                KC_TILD,KC_UNDS,KC_PLUS,KC_LCBR,KC_RCBR,KC_PIPE,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                KC_GRV,KC_MINS,KC_EQL,KC_LBRC,KC_RBRC,KC_BSLS,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                KC_LALT,KC_LGUI,KC_SPC,   KC_ENT, RAISE,LOWER \
                              //`--------------------'  `--------------------'
  ),
...
void record_pressed(uint8_t index, keyrecord_t *record) {
  pressed[index] = true;
  pressed_time[index] = record->event.time;
}
  ...
  switch (keycode) {
    ...
    case LOWER:
      if (record->event.pressed) {
        ...
        process_if_tap(0, record, set_eisu);
      }
      return false;
    case RAISE:
      if (record->event.pressed) {
        record_pressed(1, record);
        ...
        process_if_tap(1, record, set_kana);
      }
      return false;
    case ADJUST:
      if (record->event.pressed) {
